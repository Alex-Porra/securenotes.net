...
<head>
    ...
    <title><?php echo APP_NAME; ?> - Share Secrets Securely</title>
    <meta name="description" content="Share sensitive information securely with self-destructing encrypted notes. Perfect for passwords, API keys, and confidential messages.">
    <meta name="keywords" content="secure notes, encrypted sharing, self-destructing messages, password sharing">
    <!-- Open Graph -->
    <meta property="og:title" content="<?php echo APP_NAME; ?> - Share Secrets Securely">
...
<body class="custom-body">
    ...
    <div class="floating-elements">
        <i class="bi bi-incognito display-1 text-dark opacity-10 floating-element" style="top: 10%; left: 10%; font-size: 5rem;"></i>

        <i class="bi bi-eye-slash-fill display-1 text-dark opacity-10 floating-element" style="top: 20%; right: 15%; font-size: 5rem; animation-delay: -2s;"></i>
        <i class="bi bi-key-fill display-1 text-dark opacity-10 floating-element" style="bottom: 30%; left: 20%; font-size: 5rem; animation-delay: -4s;"></i>

        <i class="bi bi-shield-check display-1 text-dark opacity-10 floating-element" style="bottom: 20%; right: 10%; font-size: 5rem; animation-delay: -3s;"></i>
            ...
            <div class="row align-items-center min-vh-75">
                <div class="col-lg-6">
                    <div class="hero-content">
                        <h1 class="display-4 fw-bold mb-4">Share Secrets <span class="text-primary">Securely</span></h1>
                        <p class="lead mb-4">Send sensitive information with confidence. Your notes are encrypted and automatically destroyed after being read.</p>
                        <div class="hero-stats d-flex gap-4 mb-4">
                            <div class="stat-item">
                                <div class="h4 mb-0 text-primary">256-bit</div>
                                <small class="text-muted">Encryption</small>
                            </div>
                            <div class="stat-item">
                                <div class="h4 mb-0 text-primary">Self-Destruct</div>
                                <small class="text-muted">After Reading</small>
                            </div>
                            <div class="stat-item">
                                <div class="h4 mb-0 text-primary">Zero-Log</div>
                                <small class="text-muted">Policy</small>
                            </div>
                        </div>
                        <a href="#create-note" class="btn btn-primary btn-lg px-4 me-3">
                            <i class="bi bi-plus-circle me-2"></i>Create Secure Note
                        </a>
                    ...
                    <div class="hero-image text-center">
                        <div class="security-visual">
                            <svg xmlns="http://www.w3.org/2000/svg" width="228" height="200" fill="none">
                                <circle cx="112.34" cy="100.225" r="86.066" fill="rgba(118, 75, 162, 0)" />
                                ...
                                <path stroke="#667eea" stroke-linecap="round" stroke-width="1.612" d="M198.406 100.225c0 47.533-38.533 86.066-86.066 86.066m34.552-164.915c-10.576-4.641-22.263-7.217-34.552-7.217-47.533 0-86.066 38.533-86.066 86.066 0 30.589 15.958 57.451 40.003 72.715" />
                                <path stroke="#212529" stroke-linecap="round" stroke-width="1.5" d="M178.418 163.944c11.844 3.482 21.401 2.572 26.333-2.359 29.559-26.871-97.815-115.01-153.708-131.133-29.84-8.608-36.368 5.283-31.659 21.706" />
                                <path fill="#212529" d="m66.4 94.61-20.172 26.013a.466.466 0 0 1-.736 0L25.324 94.61c-8.022-10.345-7.098-25.045 2.16-34.303 10.15-10.15 26.605-10.15 36.755 0 9.257 9.258 10.184 23.955 2.16 34.303Z" />
                                <circle cx="45.89" cy="77.478" r="12.309" fill="#667eea" />
                                <path fill="#212529" d="m151.314 153.727-20.172 26.014a.465.465 0 0 1-.735 0l-20.169-26.014c-8.022-10.345-7.097-25.044 2.161-34.302 10.149-10.15 26.604-10.15 36.754 0 9.258 9.258 10.185 23.955 2.161 34.302Z" />
                                <circle cx="130.804" cy="136.596" r="12.309" fill="#667eea" />
                                <path fill="#212529" d="m197.533 55.915-20.171 26.013a.466.466 0 0 1-.736 0l-20.169-26.013c-8.021-10.346-7.097-25.045 2.161-34.303 10.149-10.15 26.605-10.15 36.754 0 9.258 9.258 10.185 23.955 2.161 34.303Z" />
                                <circle cx="177.024" cy="38.784" r="12.309" fill="#667eea" />
                            </svg>
                        </div>
                    </div>
                </div>
    ...
    <!-- Create Note Section -->
    <section id="create-note" class="py-5 bg-light">
        <div class="container">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form id="createNoteForm" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control form-textarea" id="noteContent" name="content" rows="6"
                                        placeholder="Enter your sensitive information here..." required maxlength="10000"></textarea>
                                    <div class="form-text">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="expiryType" class="form-label">Expiry Type</label>
                                            <select class="form-select" id="expiryType" name="expiry_type">
                                                <option value="view">After being viewed</option>
                                                <option value="time">After specific time</option>
                                                <option value="both">After viewed OR time expires</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3" id="timeExpiryGroup" style="display: none;">
                                            <label for="expiryTime" class="form-label">Expires After</label>
                                            <select class="form-select" id="expiryTime" name="expiry_time">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="maxViews" class="form-label">Maximum Views</label>
                                            <select class="form-select" id="maxViews" name="max_views">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="passcode" class="form-label">Optional Passcode</label>
                                ...
                                <div class="mb-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="emailNotification">
                                            Send me an email when this note is accessed
                                        </label>
                                    </div>
                                    <div class="mt-2" id="emailGroup" style="display: none;">
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary btn-lg custom-btn-primary" id="createBtn">
                                        <i class="bi bi-shield-lock me-2"></i>Create Secure Note
                                    </button>
                                </div>
                            </form>
                            ...
                            <div id="successMessage" class="alert alert-success mt-4" style="display: none;">
                                <h5 class="alert-heading">
                                    <i class="bi bi-check-circle me-2"></i>Note Created Successfully!
                                </h5>
                                <p class="mb-3">Your secure note has been created. Share this link:</p>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control form-control-sm" id="noteUrl" readonly>
                                    <button class="btn btn-outline-secondary btn-outline" type="button" id="copyBtn">
                                ...
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    <small class="text-muted me-2">Share via:</small>
                                    <button class="btn btn-succdess btn-sm rounded-circle p-2" id="whatsappShare" title="Share on WhatsApp">
                                        <i class="bi bi-whatsapp"></i>
                                    </button>
                                    <button class="btn btn-pridmary btn-sm rounded-circle p-2" id="emailShare" title="Share via Email">
                                ...
                                <small class="text-muted">
                                    ...
                                    Save this link now! It cannot be retrieved later.
                                </small>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center mb-5">
                    <h2 class="h2 fw-bold">Why Choose <?php echo APP_NAME; ?>?</h2>
                    <p class="lead text-muted">Built with security and privacy as top priorities</p>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="feature-card text-center p-4">
                        ...
                        <p class="text-muted">Your notes are encrypted with AES-256 before being stored. Only you and the recipient can read them.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="feature-card text-center p-4">
                        ...
                        <h4>Self-Destructing</h4>
                        <p class="text-muted">Notes automatically destroy themselves after being read or when they expire. No trace left behind.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="feature-card text-center p-4">
                        <div class="feature-icon mb-3">
                            <i class="bi bi-eye-slash-fill display-4 text-success"></i>
                        </div>
                        <h4>Zero-Log Policy</h4>
                        <p class="text-muted">We don't log or track your notes. Your privacy is paramount to us.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="feature-card text-center p-4">
                        ...
                        <h4>Passcode Protected</h4>
                        <p class="text-muted">Add an extra layer of security with optional passcode protection.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="feature-card text-center p-4">
                        ...
                        <h4>Time-Based Expiry</h4>
                        <p class="text-muted">Set custom expiration times from 1 hour to 30 days.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="feature-card text-center p-4">
                        ...
                        <p class="text-muted">Get notified when someone accesses your secure note.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center mb-5">
                    ...
                    <p class="lead text-muted">Simple, secure, and effective</p>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="step-card text-center">
                        ...
                        <p class="text-muted">Enter your sensitive information, set expiry options, and optional passcode.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="step-card text-center">
                        ...
                        <div class="step-icon mb-3">
                            <i class="bi bi-shield-lock display-5 text-success"></i>
                        </div>
                        <h5>Automatic Encryption</h5>
                        <p class="text-muted">Your message is encrypted with military-grade AES-256 encryption.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="step-card text-center">
                        ...
                        <div class="step-icon mb-3">
                            <i class="bi bi-link-45deg display-5 text-info"></i>
                        </div>
                        <h5>Share Secure Link</h5>
                        <p class="text-muted">Get a unique, one-time link to share with your intended recipient.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="step-card text-center">
                        ...
                        <div class="step-icon mb-3">
                            <i class="bi bi-fire display-5 text-danger"></i>
                        </div>
                        <h5>Auto-Destruction</h5>
                        <p class="text-muted">Message self-destructs after being read or when time expires.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="security" class="py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h2 class="h2 fw-bold mb-4">Enterprise-Grade Security</h2>
                    <div class="security-features">
                        <div class="security-item d-flex mb-3">
                            <div class="security-icon me-3">
                                <i class="bi bi-shield-check text-primary fs-4"></i>
                            </div>
                            <div>
                                <h5>AES-256 Encryption</h5>
                                <p class="text-muted mb-0">The same encryption standard used by governments and financial institutions.</p>
                            </div>
                        </div>
                        <div class="security-item d-flex mb-3">
                            <div class="security-icon me-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">Hosted on secure servers with regular security audits and updates.</p>
                            </div>
                        </div>
                        <div class="security-item d-flex mb-3">
                            <div class="security-icon me-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">Expired notes are permanently deleted from our servers automatically.</p>
                            </div>
                        </div>
                        <div class="security-item d-flex mb-3">
                            <div class="security-icon me-3">
                                <i class="bi bi-incognito text-primary fs-4"></i>
                            </div>
                            <div>
                                <h5>No Tracking</h5>
                                <p class="text-muted mb-0">We don't use cookies, analytics, or any tracking mechanisms.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="security-visual text-center">
                        <div class="security-badge">
                            <i class="bi bi-award-fill display-1 text-primary"></i>
                            <div class="mt-3">
                                <h4>Trusted & Secure</h4>
                                <p class="text-muted">Used by thousands of professionals worldwide</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Trusted By Section -->
    <section id="trusted-by" class="py-5 bg-light">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center mb-5">
                    <h2 class="h2 fw-bold">Trusted by Professionals Worldwide</h2>
                    <p class="lead text-muted">Simple, secure, and effective</p>
                </div>
            </div>
            <div class="row align-items-center justify-content-center">
                <div class="col-6 col-md-2 text-center mb-3 mb-md-0">
                    <div class="trusted-logo p-3">
                        <img src="<?php echo APP_URL ?>/assets/img/usatoday.webp" alt="USA TODAY" height="40" class="opacity-50">
                    </div>
                </div>
                <div class="col-6 col-md-2 text-center mb-3 mb-md-0">
                    <div class="trusted-logo p-3">
                        <img src="<?php echo APP_URL ?>/assets/img/cnn.webp" alt="CNN" height="40" class="opacity-50">
                    </div>
                </div>
                <div class="col-6 col-md-2 text-center mb-3 mb-md-0">
                    <div class="trusted-logo p-3">
                        <img src="<?php echo APP_URL ?>/assets/img/techradar.webp" alt="techradar" height="40" class="opacity-50">
                    </div>
                </div>
                <div class="col-6 col-md-2 text-center mb-3 mb-md-0">
                    <div class="trusted-logo p-3">
                        <img src="<?php echo APP_URL ?>/assets/img/forbes.webp" alt="Forbes" height="40" class="opacity-50">
                    </div>
                </div>
                <div class="col-6 col-md-2 text-center mb-3 mb-md-0">
                    <div class="trusted-logo p-3">
                        <img src="<?php echo APP_URL ?>/assets/img/tomsguide.webp" alt="tom's guide" height="40" class="opacity-50">
                    </div>
                </div>
                <div class="col-6 col-md-2 text-center mb-3 mb-md-0">
                    <div class="trusted-logo p-3">
                        <img src="<?php echo APP_URL ?>/assets/img/pcmag.webp" alt="pc mag" height="40" class="opacity-50">
                    </div>
                </div>
